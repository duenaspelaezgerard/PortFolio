  ...
  return (
    <div id="sobremi" className="bg-gray-700 text-white flex flex-col justify-center items-center w-full mt-10 mb-10">
      ...
      <div className="flex flex-row justify-center items-center w-full sm:flex-col mt-5">
        <div className="md:w-1/2 p-4 order-1 text-white">
          ...
          <p className="mb-8 text-base md:text-lg ">Si deseas conocer más sobre mi trabajo, puedes ver algunos ejemplos en la sección de <strong>Proyectos</strong>. Si tienes una oportunidad que se alinee con mi experiencia y pasión por el desarrollo web, estaré encantado de discutirla contigo. </p>
        </div>
        <div className="md:h-[300px] w-[300px] sm:h-[300px] w-[300px] order-2">
